...
xlabel = r'$s$'f' [au]'
ylabel = f'Cumulative number of pairs'
...
if cumulative == 'yes':
    ...
    ax.axvline(2000, color='grey', linestyle='dashed', linewidth=linewidth, zorder=0)

if cumulative == 'no':
    output_file = 'hist_rho'
    plt.hist(x1, bins=np.logspace(np.log10(0.1), np.log10(13000), 25),
