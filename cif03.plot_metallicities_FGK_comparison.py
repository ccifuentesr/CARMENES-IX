...
filter_FGK = (df['SpTnum'] >= 40) & (df['SpTnum'] < 70)
filter_MLT = (df['SpTnum'] >= 70)

Fe_H_FGK = df[filter_FGK]['Fe_H']
Fe_H_MLT = df[filter_MLT]['Fe_H']
...
ylabel = r'[Fe/H]$_{\rm FGK}$ [dex]'
xlabel = r'[Fe/H]$_{\rm M}$ [dex]'
