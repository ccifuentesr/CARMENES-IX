...
plt.hist(x, bins=np.logspace(np.log10(1e-2), np.log10(1e6), 35), density=False,
alpha=1, histtype='step', color='blue', linewidth=linewidth)
ax.axvline(13.75, color='red', linestyle='dashed', linewidth=linewidth) #0.444 arcsec, J05243-160
