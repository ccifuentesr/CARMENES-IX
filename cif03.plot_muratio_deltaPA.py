...
xlabel = r'$\mu\,$' f'ratio'
ylabel = r'$\Delta PA$' f'[deg]'

fig, ax = plt.subplots(figsize=figsize)

#
ax.scatter(x_in, y_in, facecolors='none', edgecolors='blue', s=pointsize, zorder=1)
ax.scatter(x_in_out, y_in_out, facecolors='none', edgecolors='red', s=pointsize, zorder=1)
ax.scatter(x_out, y_out, facecolors='none', edgecolors='red', s=pointsize, zorder=1)
# ax.scatter(muratio, deltaPA, c='blue', s=pointsize, zorder=0)
