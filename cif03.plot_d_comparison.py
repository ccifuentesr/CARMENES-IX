...
#
ax[0].scatter(x_out_AB, y_out_AB, facecolors='none', color='darkorange', s=pointsize, zorder=2)
ax[0].scatter(x_out_AC, y_out_AC, facecolors='none', color='darkorange', s=pointsize, zorder=2)
#
...
#
ax[1].scatter(x_out_AB, OD_out_AB, facecolors='none', color='darkorange', s=pointsize, zorder=2)
ax[1].scatter(x_out_AC, OD_out_AC, facecolors='none', color='darkorange', s=pointsize, zorder=2)
#
