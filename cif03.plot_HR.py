...
#
ax.scatter(x_single_M, y_single_M, c='lightsteelblue', marker=empty, s=pointsize, zorder=0, label='M dwarfs (single)')
ax.scatter(x_multiple_M, y_multiple_M, c='blue', marker=empty, s=pointsize, zorder=1, label='M dwarfs (multiple)')
ax.scatter(x_multiple_OBA, y_multiple_OBA, c='magenta', marker=empty, s=pointsize, zorder=1, label='OBA dwarfs')
ax.scatter(x_multiple_FGK, y_multiple_FGK, c='orange', marker=empty, s=pointsize, zorder=1, label='FGK dwarfs')
ax.scatter(x_multiple_NMS, y_multiple_NMS, c='goldenrod', s=pointsize, zorder=1, label='Non-MS stars')
ax.scatter(x_single_KO, y_single_KO, c='r', marker='x', s=pointsize, zorder=1)
ax.scatter(x_multiple_LTY, y_multiple_LTY, c='k', marker=empty, s=pointsize, zorder=1, label='Ultracool dwarfs')
ax.scatter(x_multiple_WD, y_multiple_WD, c='darkgrey', marker=empty, s=pointsize, zorder=1, label='White dwarfs')
