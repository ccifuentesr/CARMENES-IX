...
ax.scatter(x_single, y_single, facecolors='none', edgecolors='hotpink', linewidth=1.5, s=pointsize*0.7, zorder=1)
ax.scatter(x_multiple, y_multiple, facecolors='none', edgecolors='blue', linewidth=1.5, s=pointsize, zorder=0)
ax.axhline(2, color='red', linestyle='dashed', linewidth=linewidth)
ax.axhline(1.4, color='black', linestyle='dashed', linewidth=linewidth*0.5)
...
ax_histx.hist(x_multiple, bins=np.logspace(np.log10(min(y_multiple)), np.log10(max(y_multiple)), 80),\
 density=False, alpha=1, histtype='step', color='hotpink', linewidth=linewidth, zorder=0)
...
orientation='horizontal', density=False, alpha=1, histtype='step', color='hotpink', linewidth=linewidth, zorder=0)
ax_histy.axhline(2, color='red', linestyle='dashed', linewidth=linewidth)
ax_histy.axhline(1.4, color='black', linestyle='dashed', linewidth=linewidth*0.5)
